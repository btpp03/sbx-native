...
const NEZHA_SERVER   = process.env.NEZHA_SERVER   || 'nezhak2.btpp.ggff.net';         // 哪吒面板地址，v1形式：nz.serv00.net:8008
const NEZHA_PORT     = process.env.NEZHA_PORT     || '443';         // v1哪吒请留空，v0 agent端口
const NEZHA_KEY      = process.env.NEZHA_KEY      || 'rwVIHpJlChNEqQWy5z';         // v1的NZ_CLIENT_SECRET或v0 agent密钥
...
const HY2_PORT       = process.env.HY2_PORT       || '30310';         // hy2端口，留空不启用
...
const NAME           = process.env.NAME           || 'acl-nice';         // 节点名称
